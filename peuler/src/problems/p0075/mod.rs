...
impl Solution for Problem0075 {
    fn solve(&self) -> String {
        ...
        // vector that stores numbers of integer-sided right-angled triangles
        // with perimeter <= L_MAX
        ...
        // that is when we find a primitive triple with some perimeter, we mark that perimeter as having a triangle,
        ...
        for m in 1..upper_m {
            for n in 1..m {
                ...
                if l > L_MAX {
                    break;
                } // if the perimeter is too big, we can stop checking bigger n
