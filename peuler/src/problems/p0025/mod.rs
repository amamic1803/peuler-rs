...
impl Solution for Problem0025 {
    fn solve(&self) -> String {
        ...
        // we know that the wanted number needs to have at least 1000 digits
        ...
        // plugging that into the inequality, we get a^n / sqrt(5) >= 10^999
